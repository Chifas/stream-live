  ...
  return (
    <div className="mx-auto max-w-[1600px] p-4 sm:p-6">
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <span className="inline-flex items-center gap-1 rounded bg-live px-2 py-0.5 text-xs font-bold uppercase text-white">
            <span className="h-1.5 w-1.5 rounded-full bg-white live-dot" /> En directo
          </span>
          ...
          <p className="mt-3 text-sm font-semibold text-brand-2">
            {formatViewers(featured.baseViewers)} espectadores ahora mismo
          </p>
        </div>
      </Link>
      ...
      <section className="mb-10">
        <h2 className="mb-4 text-xl font-bold">Directos populares</h2>
